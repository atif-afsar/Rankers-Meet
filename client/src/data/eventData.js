  ...
  highlights: [
    {
      ...
      title: 'Trophy Presentation by Yasir Ali Sir',
      subtitle: 'Recognizing Top CA Foundation, AMU & CUET Commerce Rankers with engraved awards',
      year: 'Rankers Meet',
      badge: 'Main Stage',
    ...
    {
      id: 2,
      category: 'Parent Pride',
      title: 'Honoring Proud Parents on Stage',
      subtitle: 'Felicitation shawls and mementos presented to families for their steadfast dedication',
      year: 'Rankers Meet',
      badge: 'Special Honor',
    ...
    },
    {
      ...
      title: 'Historic CA Foundation Clearances',
      subtitle: 'Celebrating Yasir Ali Classes students achieving landmark scores in ICAI examinations',
      year: 'Rankers Meet',
      badge: 'CA Wing',
    ...
    },
    {
      id: 4,
      category: 'Mentorship',
      title: 'Faculty Keynote & Career Roadmap',
      subtitle: 'Senior educators providing roadmap guidance for articleship, college seats, and entrance counseling',
      year: 'Rankers Meet',
      badge: 'Mentorship',
    ...
    {
      id: 5,
      category: 'CUET Distinction',
      title: 'Commerce Central University Achievers',
      subtitle: 'Record-setting performance in Accountancy, Economics, and admission to top institutions like SRCC',
      year: 'Rankers Meet',
      badge: 'CUET Distinction',
    ...
    },
    {
      ...
      title: 'Grand Celebration & Media Press',
      subtitle: 'Memorable candid moments, celebratory VIP lunch banquet, and student interviews',
      year: 'Rankers Meet',
      badge: 'VIP Lunch',
